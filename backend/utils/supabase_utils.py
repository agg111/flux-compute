...
def save_migration_to_supabase(workload_id: str, migration_data: dict):
    ...
    try:
        ...
        data = {
            ...
            'recommended_instance_type': migration_data.get('recommended_instance_type'),
            ...
            'actual_cost_per_hour': migration_data.get('actual_cost_per_hour'),
            ...
            'ai_powered': migration_data.get('ai_powered', False),
            'ai_confidence': migration_data.get('ai_confidence'),
            'created_at': datetime.now(timezone.utc).isoformat(),
            'updated_at': datetime.now(timezone.utc).isoformat()
        }
